...
const Hero = () => {
  return (
    <div className='relative top-0 left-0 m-0 w-full min-h-[640px] sm:min-h-[720px] md:min-h-[860px] lg:min-h-0 lg:h-[calc(100vh-66px)] lg:max-h-[960px] sm:px-[55px] md:px-16 lg:px-[100px] xl:px-[139px] pt-10 pb-8 sm:pt-12 sm:pb-10 lg:pt-0 lg:pb-[63px]'>
        <Image
            src={'/home/hero.png'}
            fill
            sizes='100vw'
        ...
        <div className='text-[#F9FAFB] absolute bottom-[-76px] sm:bottom-10 lg:bottom-0 left-4 right-4 xs:left-6 xs:right-6 sm:left-10 sm:right-10 md:left-16 md:right-16 lg:left-[100px] lg:right-[100px] xl:left-[139px] xl:right-[139px] font-sans max-w-[1162px] w-auto mt-[156px] lg:mt-0'>
            ...
            <div className='mt-6 mb-6 sm:mt-8 sm:mb-8 lg:mt-[43px] lg:mb-[23.8px] flex flex-col md:flex-row gap-2 sm:gap-3 items-center md:items-start'>
                <Button className={'w-[195px] h-14 md:h-12 rounded-[10px] px-6 py-3 sm:px-10 lg:px-[60px] lg:py-4'}>Join ULES</Button>
                <Button variant={'outline'} className={'w-[195px] h-14 md:h-12 rounded-[10px] px-6 py-3 sm:px-10 lg:px-[60px] lg:py-4 bg-transparent'}>Discover</Button>
            </div>
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 lg:gap-5 justify-center align-center w-full rounded-lg border border-white/25 bg-transparent px-3 py-4 sm:px-5 sm:py-[26px] shadow-lg backdrop-blur-[2px]'>
                <div className='flex flex-col gap-2 justify-center align-center text-center text-[#F9FAFB]'>
